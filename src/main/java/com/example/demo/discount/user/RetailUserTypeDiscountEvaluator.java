...
@Component
public class RetailUserTypeDiscountEvaluator implements UserTypeDiscountEvaluator {

    private static final BigDecimal thresholdAmount = BigDecimal.valueOf(50_000);
    private static final BigDecimal percentage = BigDecimal.valueOf(18);

    private final TransactionService transactionService;

    public RetailUserTypeDiscountEvaluator(TransactionService transactionService) {
